...
!function (a) {
  ...
  a.fn.attr2 = function () {
    ...
    for (k = 0, p = j.length; k < p; k++) {
      if (o = j[k], (m = o.name) && !o.disabled) if (b && h.clk && "image" === o.type) h.clk === o && (f.push({
        name: m,
        value: a(o).val(),
        type: o.type
      }), f.push({
        ...
        name: m + ".y",
        value: h.clk_y
      }));else if ((n = a.fieldValue(o, !0)) && n.constructor === Array) for (c && c.push(o), l = 0, q = n.length; l < q; l++) {
        f.push({
          name: m,
          value: n[l]
        });
        ...
        c && c.push(o);
        var r = o.files;
        if (r.length) for (l = 0; l < r.length; l++) {
          f.push({
            name: m,
            value: r[l],
            type: o.type
    ...
    return this.each(function () {
      ...
      if (d) {
        ...
        if (e && e.constructor === Array) for (var f = 0, g = e.length; f < g; f++) {
          c.push({
            name: d,
            value: e[f]
          });
