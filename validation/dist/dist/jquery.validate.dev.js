...
(function (factory) {
  ...
  $.validator.addMethod("uName", function (value, element, param) {
    var reg = /^[a-zA-z]\w{3,15}$/;
    return this.optional(element) || reg.test(value);
  }, "4-16位字母、数字、下划线组合");
  $.validator.addMethod("uPwd", function (value, element, param) {
    var reg = /^[a-zA-Z0-9]{6,22}$/;
    return this.optional(element) || reg.test(value);
  }, "6-22位字母数字");
  $.validator.addMethod("uTel", function (value, element, param) {
    var reg = /^1[3-9]\d{9}$/;
    return this.optional(element) || reg.test(value);
  }, "请输入正确的手机号");
});